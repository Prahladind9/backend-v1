...
public class PersonMain {
    public static void main(String[] args) {
        ...
        //Calling getPerson() method which will return the
        //List of Person in sorted order.
        ...
        persons.stream().forEach((person) -> System.out.println("Person Name: " +person.getName()));
    }
}
